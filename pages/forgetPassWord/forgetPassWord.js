...
Page({
  ...
  formsubimt() {
    ...
    if (phone == '' || phone == ' ' || phone == null) {
      ...
      wx.request({
        url: app.globalData.serverWJ + 'wx/user/getPassWord.do',
        method: 'POST',
  ...
  getmsg(random, phone) {
    wx.request({
      url: app.globalData.serverWJ + 'wx/user/sendMessageForPassWord.do',
      method: 'POST',
      data: {
        "random": random,
        "telephone": phone
  ...
  onLoad: function (options) {
    ...
    wx.request({
      ...
      success: (result) => {
        ...
        wx.request({
          url: app.globalData.serverWJ + 'wx/user/toForgetPassWord.do',
          method: 'POST',
          header: {
