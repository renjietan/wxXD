...
Page({
  ...
  submit() {
    ...
    if (amount == "" || amount == null) {
      ...
      if (this.data.id) {
        //编辑
        $request({
          url: app.globalData.server9696 + "machinery/updMachinery",
          type: "form",
        ...
        //添加
        $request({
          url: app.globalData.server9696 + "machinery/addMachinery",
          type: "form",
  ...
  onLoad: function(options) {
    ...
    if (options.id) {
      ...
      $request({
        url: app.globalData.server9696 + "machinery/findMachineryOne",
        type: "form",
        params: {
