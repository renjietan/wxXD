...
Page({
  ...
  getAlllist() {
    ...
    $request({
      url: app.globalData.serverBook + "Other_production_marketing/selectOtherOrderByoutput",
      method: "POST",
      type: 'form',
    }).then(res => {
      setTimeout(() => {
  ...
  del(id) {
    $request({
      url: app.globalData.serverBook + "Other_production_marketing/isInvalidOther",
      method: "POST",
      type: "form",
      params: {
        id: id,
